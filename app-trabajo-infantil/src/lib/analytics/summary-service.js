export function buildExecutiveSummary(snapshot) {
  return {
    paragraphs: [
      `El dashboard muestra el anio ${snapshot.primaryYear} por defecto y recalcula indicadores con los filtros activos.`,
      ...
      snapshot.annualComparison.isVisible
        ...
        : "Por ahora solo existe 2024 como base limpia; la comparacion anual queda desactivada hasta cargar otro anio.",
    ],
  };
}
